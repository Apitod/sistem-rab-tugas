...
@section('header_title', 'Dashboard Dekan')

@section('content')
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
    <div class="bg-white rounded-xl shadow p-6 flex items-center space-x-4">
        <div class="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center">
            <i class="fa-solid fa-stamp text-secondary text-xl"></i>
        </div>
        <div>
            <p class="text-sm text-gray-500">Menunggu Persetujuan Dekan</p>
    ...
    <div class="bg-white rounded-xl shadow p-6 flex items-center space-x-4">
        ...
        <div>
            <p class="text-sm text-gray-500">Total Anggaran Menunggu</p>
...
<div class="bg-white rounded-xl shadow p-6">
    <h2 class="text-lg font-semibold text-gray-700 mb-4">RAB Menunggu Persetujuan Dekan</h2>
    @if($proposals->isEmpty())
        <p class="text-gray-400 text-center py-8">Tidak ada RAB yang menunggu persetujuan.</p>
    @else
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-center">
                            <a href="{{ route('dekan.rab.show', $p->id) }}" class="text-secondary hover:underline text-xs">Review & Setujui</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
