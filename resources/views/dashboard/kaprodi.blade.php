...
@section('header_title', 'Dashboard Kaprodi')
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
    <div class="bg-white rounded-xl shadow p-6 flex items-center space-x-4">
        ...
        <div>
            <p class="text-sm text-gray-500">Menunggu Verifikasi Saya</p>
    ...
    <div class="bg-white rounded-xl shadow p-6 flex items-center space-x-4">
        ...
        <div>
            ...
            <p class="text-2xl font-bold text-gray-800">{{ $ewData['count'] ?? 0 }}</p>
        </div>
    </div>
    @endif
</div>
...
<div class="bg-white rounded-xl shadow p-6">
    <h2 class="text-lg font-semibold text-gray-700 mb-4">RAB Menunggu Verifikasi</h2>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-center">
                            <a href="{{ route('kaprodi.rab.show', $p->id) }}" class="text-secondary hover:underline text-xs">Review</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
